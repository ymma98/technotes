...
* 映射 $f: \mathbb{R}^{2} \rightarrow \mathbb{R}^{2}$ 称作 affine transformation 如果 $f$ 把直线映射到直线 (但对距离没有要求, 可以是圆到椭圆。仿射变换一定是平行si'bian'xin)。


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYxOTUxNDMyOCwxNTY2MTc4MDQxLDEwNT
