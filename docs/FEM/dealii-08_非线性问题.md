...
$$
\frac{dR(u_k)}{du_k} \delta u_k = \frac{D}{} = \lim_{\epsilon\rightarrow0} \frac{dR[u_k + \epsilon \delta u_k] - dR[u_k]}{d\epsilon} = \frac{\partial R}{\partial u_k} \delta u_k
$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUzOTc2NjQxLDI0NjUwMDY1OSwxNzEwND
