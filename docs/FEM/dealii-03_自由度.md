...
在当前的教程程序中，我们展示了如何通过定义在该网格上的自由度（degrees of freedom，简称 DoF）的概念来表示分段多项式函数。在本例中，我们将使用最低阶的有限元 $Q_1$，即我们寻找的逼近函数 $u_h$ 在网格的每个四边形单元 $K$ 上是“双线性”的。（如果我们使用三角形单元，则 $u_h$ 是线性的。）
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEwMDA3NTEzMF19
-->