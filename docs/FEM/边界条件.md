...
* 如果 $B^2 - A C = 0$，对应于抛物方程，只有一条退化了的特征线，time-evolution equation with a smoothing (diffusive) effect, 给定 t=0 时刻

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2OTMwNTUyOTUsMTg2MjM3MjU5NywyMD
