...
* 如果 $B^2 - A C = 0$，对应于抛物方程，只有一条退化了的特征线，time-evolution equation with a smoothing (diffusive) effect, 需要给定 t=0 时刻的initial value

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYwNzYzMjI3MywxODYyMzcyNTk3LDIwMj
g4NDk0MjEsOTEyODE3MjAzLDM3ODE1MTc4MywyMDUxNDcyMzEx
LDE1MzU0NzIwMjAsLTE4MjUzMTIyNTksNjI1MzI0OTAxLC0xNj
