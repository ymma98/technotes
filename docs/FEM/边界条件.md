...
* 如果 $B^2 - A C < 0$，对应于椭圆方程, PDE 方程不存在特征线, 此时扰动不沿着特定的线传播，而是向空间中所有方向传播，边值会影响整个domain，解是guang
* 如果 $B^2 - A C = 0$，对应于抛物方程，

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MzkxMjk4NzQsMTg2MjM3MjU5NywyMD
I4ODQ5NDIxLDkxMjgxNzIwMywzNzgxNTE3ODMsMjA1MTQ3MjMx
MSwxNTM1NDcyMDIwLC0xODI1MzEyMjU5LDYyNTMyNDkwMSwtMT
Y5NzY4MTI0MCw2MzA1MzQ3NzgsNDM2Mzg5Nzk2LDQyNDQyNjYz
XX0=
-->