...
* 如果 PDE 在 $\mathbf{x_0}$ 上, 所有的 $a_j(\mathbf{x})$ 都是非零且不具有相同的符号, 那么 SOPDE 就是 **ultrahperbolic type** 的。



<!--stackedit_data:
eyJoaXN0b3J5IjpbNzI4MzE0ODMwLDYzMDUzNDc3OCw0MzYzOD
k3OTYsNDI0NDI2NjNdfQ==
-->