...
| IBM Coral Systems        | xlc_r, cc_r, xlc++_r, xlc89_r, xlc99_r,     | -qsmp=omp    |
|                           | xlf_r, xlf90_r, xlf95_r, xlf2003_r *Be sure |
|                           | to use a thread-safe compiler - its name   |
|                           | ends with _r                               |              |
...
_Parallel section executed by all threads 
                 .
Other OpenMP directives
                 .
Run-time Library calls
                 .
All threads join master thread and disband_**
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEzNjAwMTE2LC02ODg0NTk2NjEsNDQ4OT
k3MDExLC0xMDMyNzU0ODA0LC0xMDA4Njc2MjI3LC0xMTc2ODQ0
NTcxLC00NTY3NTI5ODAsMTc0NTY2MDMyMSwxNjUwNDkzNzE1LC
0yMTI5MzgxODQyLC05Njc0MTA1OTIsLTMxOTQyMjU2MiwtMTg1
ODIzNDQ3Nl19
-->