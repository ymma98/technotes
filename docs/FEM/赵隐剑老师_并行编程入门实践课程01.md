...
int main() {
    ...
    #pragma omp parallel default(firstprivate)
    {
        ...
        // In Fortran: if (omp_i == 0) write(*,*) "0"
        // In C++: if (omp_i == 0) std::cout << "0\n";
        if (omp_i == 0) {
            std::cout << "0\n";
        }
    } // This implicitly corresponds to !$omp end parallel in Fortran
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMDg2NzYyMjcsLTExNzY4NDQ1NzEsLT
Q1Njc1Mjk4MCwxNzQ1NjYwMzIxLDE2NTA0OTM3MTUsLTIxMjkz
ODE4NDIsLTk2NzQxMDU5MiwtMzE5NDIyNTYyLC0xODU4MjM0ND
c2XX0=
-->