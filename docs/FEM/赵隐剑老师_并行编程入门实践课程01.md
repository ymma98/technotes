...
此外，还有 `dynamic` 调度类型。在 `dynamic` 调度类型中，循环项分配给不同线程的顺序是不可预测的。每个线程会向 OpenMP 运行时库请求一个迭代号，处理完后再请求下一个，如此往复。  
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU5Njc0NTQyOSwtNjc4MzQ4MDY0LC05MT
U5NDg3MTMsLTE3ODg5NDQ3ODYsLTY4ODQ1OTY2MSw0NDg5OTcw
MTEsLTEwMzI3NTQ4MDQsLTEwMDg2NzYyMjcsLTExNzY4NDQ1Nz
EsLTQ1Njc1Mjk4MCwxNzQ1NjYwMzIxLDE2NTA0OTM3MTUsLTIx
MjkzODE4NDIsLTk2NzQxMDU5MiwtMzE5NDIyNTYyLC0xODU4Mj
M0NDc2XX0=
-->