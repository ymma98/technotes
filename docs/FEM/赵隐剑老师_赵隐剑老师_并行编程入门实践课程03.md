...
$$
\vec{E}_i 
= k_e \sum_{j \neq i} \frac{\hat{r}_{ij}}{\bigl\lvert \vec{r}_{ij} \bigr\rvert^2}
$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzM4NjY3ODYxLDU1MzQ0MTYzNiwtMTgwMj
Y2OTg5M119
-->