...
-   **[capture clause]** 标记了 lambda 的声明以及如何捕获局部作用域参数（按值捕获、按引用捕获等）。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0ODk4MjE5MTMsLTE1OTk5NTEyNDUsLT
E4NjE0ODM1NDQsMTAzNDE5MjMxNSwtMTg0MTIwMzcyMywxNTA3
Mjc0NDkyLDE4NTQwNDc2MDFdfQ==
-->