...
一个C++程序由特定于语言的关键字（`keywords`, 如for、if、new、true 等）、标识符（`identifiers`, 用于变量 variables、函数 functions、结构体 structures、命名空间 namespaces 等的符号）、表达式（定义为操作符的序列）以及字面量（常量值令牌）组成。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA0MzcxOTI2MiwxMzE4MTQxNTExLDE2Nj
AxNDE3NDMsLTg0NTg1MDI4NSwxMDM1MDA5Njc4LDE0NzYxNzgw
MDAsLTEyMzg1NzAwMTEsLTIxMDI1OTk1MDEsLTE2NDg5NzY0ND
AsOTYwMDk0NTk4LC0xNTA4MTI1ODgwLDIwMjEzMDEyMjksLTY3
MjcwNDAyMCwtMzEyMjkyNTQ4LC0xNjM1OTkzMjUyLC0xNDEyMz
U2NTg4LC0xMTk5MjYzODc2LDk0MDc3Njg4MCwtNDQzMjc5OTA3
LC0xMTgzNDc3NTI4XX0=
-->