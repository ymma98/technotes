...
* c++ 类型的性质 (properties)
	...
	* 名称 (name)，并非所有对象都有名称, 比如 `someFunction(MyClass(5));` 中的 `
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEwNjc5ODM4MCwtMTE4ODQ4MjIxMiwxOT
U5OTMyMjQ3LC0yMzA1OTQ4OSwxMzY5NzU1NiwtODY2MjMzNjEz
LDQ1NjkxOTE4NywxNDc0MDI2MDI3XX0=
-->