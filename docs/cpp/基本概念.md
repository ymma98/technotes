...
* c++ 类型的性质 (properties)
	...
	* 对齐要求 (alignment requirement), 可以用 `alignof` 查询
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMzI4MTc3NDEsLTExODg0ODIyMTIsMT
k1OTkzMjI0NywtMjMwNTk0ODksMTM2OTc1NTYsLTg2NjIzMzYx
Myw0NTY5MTkxODcsMTQ3NDAyNjAyN119
-->