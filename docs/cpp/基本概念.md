...
* 一些形容 c++ 类型的方式
	* 标量 (scalar)。
		...
		* 可以逐位复制（Trivially Copyable）：标量类型的对象可以通过简单的内存复制操作来复制，不需要复杂的复制逻辑。这意味着如果你将一个标量类型的变量的内存内容复制到另一个同类型变量的内存中，复制后的变量将具有与原变量相同的值
		* 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MDI4NDY4MjcsLTExODM0Nzc1MjgsLT
ExODg0ODIyMTIsMTk1OTkzMjI0NywtMjMwNTk0ODksMTM2OTc1
NTYsLTg2NjIzMzYxMyw0NTY5MTkxODcsMTQ3NDAyNjAyN119
-->