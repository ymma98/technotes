...
\* 4 bytes on Windows64 systems, $\dagger$ signed/unsigned, two-complement from C++11 (二进制补码（Two's complement）是一种整数的二进制表示方法，广泛用于表示有符号整数)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NTkwNTI0NTMsLTExOTkyNjM4NzYsOT
