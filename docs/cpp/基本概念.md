...
| 2 | $+\mathrm{a}-\mathrm{a}++\mathrm{a}--\mathrm{a}$ <br> $!$ not $\sim$ | Plus/minus, Prefix increment/decrement, <br> Logical/Bitwise Not | Right-to-left |
| 3 | $\mathrm{a} * \mathrm{~b} \quad \mathrm{a} / \mathrm{b} \quad \mathrm{a} \% \mathrm{~b}$ | Multiplication, division, and remainder | Left-to-right |
| 4 | $\mathrm{a}+\mathrm{b} \quad \mathrm{a}-\mathrm{b}$ | Addition and subtraction | Left-to-right |
| 5 | $\ll \gg$ | Bitwise left shift and right shift | Left-to-right |
| 6 | $<<=>\rangle=$ | Relational operators | Left-to-right |
| 7 | $==\quad!=$ | Equality operators | Left-to-right |
| 8 | & | Bitwise AND | Left-to-right |
| 9 | へ | Bitwise XOR | Left-to-right |
| 10 | I | Bitwise OR | Left-to-right |
| 11 | && and | Logical AND | Left-to-right |
| 12 | $\\|$ or | Logical OR | Left-to-right |
| 13 | $+=-=*=/=\%=$ <br> $<<=>>=\quad \&=\sim=\mid=$ | Compound | Right-to-left |
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODUxNTcyODUsLTEyMzg1NzAwMTEsLT
IxMDI1OTk1MDEsLTE2NDg5NzY0NDAsOTYwMDk0NTk4LC0xNTA4
MTI1ODgwLDIwMjEzMDEyMjksLTY3MjcwNDAyMCwtMzEyMjkyNT
Q4LC0xNjM1OTkzMjUyLC0xNDEyMzU2NTg4LC0xMTk5MjYzODc2
LDk0MDc3Njg4MCwtNDQzMjc5OTA3LC0xMTgzNDc3NTI4LC0xMT
g4NDgyMjEyLDE5NTk5MzIyNDcsLTIzMDU5NDg5LDEzNjk3NTU2
LC04NjYyMzM2MTNdfQ==
-->