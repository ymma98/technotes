...
constexpr 的非静态成员函数，如果包含数据成员或非编译时函数，那么在运行时对象中不能在编译时使用** **静态 constexpr 成员函数则不会出现这个问题，因为它们不依赖于具体的实例**
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg0ODg5MjAxMSw1Njk3MjI4NzUsNTMwOT
Y0MzcxLDE4NDYwMzc4NDEsMTY0NjU1OTUxNiwtNzgyNjcxNTcy
LC0xMTI1MDMwOTE4LC0xODU1MDYwOTY0LC05ODcxODA5NTAsMT
Y3NzcxNTM2MCwxNjg4NDE0NDEsNzY4ODQ0NDEsLTQzODI4MTMw
NywxOTg3MzI4NzExLDEwMDk4MzIzNTUsLTE0OTE3MzUyNTgsLT
EwMzgwOTIxODcsLTE2NDExNDE5MjUsMTY2Mjg3OTE0XX0=
-->